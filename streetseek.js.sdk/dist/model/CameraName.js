 ...
 * @version 1.0.0
 */
var CameraName = /*#__PURE__*/function () {
  /**
   ...
   */
  function CameraName(cameraName) {
    _classCallCheck(this, CameraName);
  ...
  _createClass(CameraName, null, [{
    key: "initialize",
    value: function initialize(obj, cameraName) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('cameraName')) {
          obj['cameraName'] = _ApiClient["default"].convertToType(data['cameraName'], 'String');
        }
      }
