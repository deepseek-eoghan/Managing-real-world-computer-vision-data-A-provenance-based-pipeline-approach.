...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreetseekServer.TotalCameraDensity();
  });
  ...
  describe('TotalCameraDensity', function() {
    it('should create an instance of TotalCameraDensity', function() {
      // uncomment below and update the code to test TotalCameraDensity
      //var instane = new StreetseekServer.TotalCameraDensity();
      //expect(instance).to.be.a(StreetseekServer.TotalCameraDensity);
    });
