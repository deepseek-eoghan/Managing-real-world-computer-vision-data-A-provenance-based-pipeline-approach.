...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreetseekServer.TotalCameraTimeSpent();
  });
  ...
  describe('TotalCameraTimeSpent', function() {
    it('should create an instance of TotalCameraTimeSpent', function() {
      // uncomment below and update the code to test TotalCameraTimeSpent
      //var instane = new StreetseekServer.TotalCameraTimeSpent();
      //expect(instance).to.be.a(StreetseekServer.TotalCameraTimeSpent);
    });
